...
public class AMemberInsertCommand implements ACommand{
	...
	public void execute(Model model) {
		...
		adao.memberInsert(member_id, member_pw, member_name, member_nick, member_tel, member_email, member_image, member_date);
	}
